...
(function() {
  ...
  },
  {
    ...
    "hasTreatment": true,
    "treatmentType": "체질 맞춤 한약 + CST 뇌척수 순환요법",
    "content": "회의를 하거나 중요한 발표를 앞두면 갑자기 숨이 가빠지면서 과호흡이 오고, 손발 끝이 찌릿찌릿 저리며 마비되듯 굳어버렸습니다. 뒷목과 어깨가 돌처럼 뭉치고 찌릿한 긴장성 두통과 어지럼증까지 동반되어 사회생활이 불가능했습니다. 해아림에서 과호흡 응급 4-6 호흡법 교정과 함께 뇌신경 순환을 개선하는 두개천골요법, 맞춤 한약을 병행하여 3개월 만에 모든 증상이 호전되어 건강을 되찾았습니다."
  },
  {
    "id": "pool-rev-7",
    "category": "회의 & 발표 공황",
  ...
  },
  {
    "id": "pool-rev-9",
    "category": "신경안정제 단약",
    "title": "자낙스를 3년 복용하며 끊지 못했는데, 한약 병행 후 신체 부담을 덜며 단약 성공했습니다",
  ...
  },
  {
    "id": "pool-rev-18",
    "category": "식은땀 & 오한",
    "title": "불안할 때마다 등줄기에 식은땀이 비 오듯 쏟아지고 손발이 얼던 증상이 호전되어 건강을 되찾았습니다",
  ...
  },
  {
    "id": "pool-rev-20",
    "category": "영화관 공황",
    "title": "어둡고 밀폐된 영화관이나 공연장에 가면 숨 막히던 광장공포증 극복",
    "author": "30대 교사 노OO 님",
    "hasTreatment": false,
    "treatmentType": "",
  ...
  },
  {
    "id": "pool-rev-23",
    "category": "시험 불안 & 공황",
    "title": "공무원 시험장에서 시험지 받자마자 눈앞이 캄캄해지던 공황, 극복 후 합격했습니다",
  ...
  },
  {
    ...
    "hasTreatment": false,
    "treatmentType": "",
    "content": "터널에 들어가면 전방 시야가 좁아지고 숨이 막혀 비상등을 켜고 멈춘 적이 있었습니다. 해아림에서 3단계 한방 치료와 인지행동 지도를 받으며 터널 공포를 원활히 극복했습니다."
  }
];
