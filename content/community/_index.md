...
description: "공황장애에 대해 자주 묻는 질문(FAQ), 환자분들의 생생한 실제 치료후기, 원장단이 직접 설명하는 유튜브 의학 영상 및 체계적 치료 칼럼을 제공합니다."
type: landing
sections:
  - block: markdown
    content:
      ...
      text: |
        ...
        var CURRENT_COMMUNITY_EPOCH = '20260915_panic_v13';
        try {
            ...
            fetch('/data/healim_community_hub.json?t=' + Date.now(), { cache: 'no-cache' })
              ...
              .then(function(json) {
                if (json) {
                  ...
                  if (!data || data.epoch !== CURRENT_COMMUNITY_EPOCH || (data.version && data.version < 13)) {
